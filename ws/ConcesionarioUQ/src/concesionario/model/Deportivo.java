...
//DATOS PROPIEDADES NO SE SABE QUE ES
    public Deportivo(String marca, boolean esNuevo, String modelo, int cambios,TipoTransmision tipoTransmision,TipoCombustible tipoCombustible, int velocidadMaxima, int cilindraje, int nPasajeros, int nPuertas,
    				int nBolsasAire, int numCaballosFuerza, int tiempo0a100kmh, boolean aireAcondicionado, boolean camaraReversa, boolean abs ) {
        super(marca, esNuevo, modelo, cambios, tipoTransmision, tipoCombustible, velocidadMaxima, cilindraje, aireAcondicionado, nPuertas, camaraReversa, nBolsasAire, nPasajeros, abs);
